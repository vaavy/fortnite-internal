...
static const char* GetUObjectNameLoop(UObject* Object) {
	...
	for (auto i = 0; Object; Object = Object->Outer, ++i) {
		...
		auto fGetObjName = reinterpret_cast<FString * (__fastcall*)(int* index, FString * res)>(GETNAMEBYINDEX); //WRONG
...
static PVOID FindAllObjects(const char* name, const char* name2) {
	...
	std::cout << "NOPE IT WILL CRASH:"<< std::endl;
	return 0;
}
...
{
	auto SetControlRotation_ = (*(void(__fastcall**)(uintptr_t Controller, Vector3 NewRotation, bool bResetCamera))(*(uintptr_t*)PlayerController + 0x728));
